...
{
    class Protocol_TeltonikaFMXXXX
    {
      ...
      public static string Parsebytes(Byte[] byteBuffer, int index, int Size)
        {
            return BitConverter.ToString(byteBuffer, index, Size).Replace("-", string.Empty);
        }

     public static string parseIMEI(Byte[] byteBuffer, int size)
        {
            int index = 0;
 ...
 public  bool checkIMEI(string data)
        {
        ...
        public  Byte[] DealingWithHeartBeat(string data)
        {
        ...
        public  string ParseHeartBeatData(Byte[] byteBuffer, int size)
        {
